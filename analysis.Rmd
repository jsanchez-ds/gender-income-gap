...
(1.0 puntos) Utilice mecanismos automáticos de selección de variables para refinar los resultados de la pregunta anterior y discuta cuál de todas las especificaciones es la que mejor describe los ingresos observados. 
...
Se utilizó ChatGPT para tener el código de gráficos y para transformación de variables. 